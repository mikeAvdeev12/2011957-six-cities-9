...
type CommentFormScreenProps = {
  onAnswer: () => void;
}

function CommentForm(props: CommentFormScreenProps): JSX.Element {
  ...
  const changeFileHandler = (event: ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => {
    ...
    >
      ...
      <div className="reviews__rating-form form__rating">
        <input className="form__rating-input visually-hidden" name="rating" value="5" id="5-stars"
          type="radio" onChange={changeFileHandler}
        />
        ...
        <input className="form__rating-input visually-hidden" name="rating" value="3"
          id="3-stars" type="radio" onChange={changeFileHandler}
        />
        ...
        <input className="form__rating-input visually-hidden" name="rating" value="2"
          id="2-stars" type="radio" onChange={changeFileHandler}
        />
        ...
        <input className="form__rating-input visually-hidden" name="rating" value="1"
          id="1-star" type="radio" onChange={changeFileHandler}
        />
